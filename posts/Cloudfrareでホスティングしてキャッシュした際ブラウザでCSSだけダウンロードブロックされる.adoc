...
. Webサイトの設定画面を表示
. [キャッシュをパージ]をクリック
** image:./Cloudfrareでホスティングしてキャッシュした際ブラウザでCSSだけダウンロードブロックされる/2021-11-22_07h40_18.png[]
. [すべてパージ]をクリック
** image:./Cloudfrareでホスティングしてキャッシュした際ブラウザでCSSだけダウンロードブロックされる/2021-11-22_07h41_22.png[]
